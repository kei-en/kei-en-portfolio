...
export default function About({ inView }) {
  ...
  return (
    <div
      ...
      className={
        'h-[calc(100vh-7rem)] bg-grey w-[90%] m-auto mb-20 p-2 rounded-lg flex flex-col text-center overflow-hidden'
      }
    >
      <Title title={textHdr} />
      <div className="h-full lg:pt-5 pb-10">
        ...
        >
          ...
          and technologies in the field. Feel free to get in touch below if
